...
// Address for Seventh Mode (0=Disable, 1=Diatonic 7th, 2=Diminished 7th)
#define NVRAM_SEVENTH_ADDR 10
...
extern int currentSeventhMode;      // 0=Disable, 1=Diatonic 7th, 2=Diminished 7th
